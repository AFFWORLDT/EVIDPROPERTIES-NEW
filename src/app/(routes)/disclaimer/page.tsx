...
export const metadata: Metadata = {
  title: 'Disclaimer - Apricity Real Estate',
  description: 'Disclaimer for Apricity Real Estate - Important information about our services and limitations.',
};
    ...
    <div className="min-h-screen bg-gray-50 py-12">
      <div className="container mx-auto px-4 max-w-4xl">
        <div className="bg-white rounded-lg shadow-lg p-8">
          <h1 className="text-4xl font-serif font-normal text-gray-900 mb-8 font-serif">Disclaimer</h1>
          ...
          <div className="prose prose-lg max-w-none">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-serif font-normal text-gray-900 mb-4 font-serif">1. General Information</h2>
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-serif font-normal text-gray-900 mb-4 font-serif">2. Property Information Disclaimer</h2>
              
              <h3 className="text-xl font-serif font-normal text-gray-800 mb-3 font-serif">2.1 Accuracy of Property Details</h3>
              <p className="text-gray-700 mb-4">
              ...
              <h3 className="text-xl font-serif font-normal text-gray-800 mb-3 font-serif">2.2 Property Availability</h3>
              <p className="text-gray-700 mb-4">
              ...
              <h3 className="text-xl font-serif font-normal text-gray-800 mb-3 font-serif">2.3 Property Prices and Valuations</h3>
              <p className="text-gray-700 mb-4">
              ...
              <h3 className="text-xl font-serif font-normal text-gray-800 mb-3 font-serif">2.4 Property Images and Descriptions</h3>
              <p className="text-gray-700 mb-4">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-serif font-normal text-gray-900 mb-4 font-serif">3. Real Estate Services Disclaimer</h2>
              
              <h3 className="text-xl font-serif font-normal text-gray-800 mb-3 font-serif">3.1 Professional Advice</h3>
              <p className="text-gray-700 mb-4">
              ...
              <h3 className="text-xl font-serif font-normal text-gray-800 mb-3 font-serif">3.2 Market Information</h3>
              <p className="text-gray-700 mb-4">
              ...
              <h3 className="text-xl font-serif font-normal text-gray-800 mb-3 font-serif">3.3 Legal and Regulatory Compliance</h3>
              <p className="text-gray-700 mb-4">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-serif font-normal text-gray-900 mb-4 font-serif">4. Website and Technology Disclaimer</h2>
              
              <h3 className="text-xl font-serif font-normal text-gray-800 mb-3 font-serif">4.1 Website Availability</h3>
              <p className="text-gray-700 mb-4">
              ...
              <h3 className="text-xl font-serif font-normal text-gray-800 mb-3 font-serif">4.2 Third-Party Links</h3>
              <p className="text-gray-700 mb-4">
              ...
              <h3 className="text-xl font-serif font-normal text-gray-800 mb-3 font-serif">4.3 User-Generated Content</h3>
              <p className="text-gray-700 mb-4">
                Any content submitted by users, including reviews, comments, or other materials, represents the views of the individual user and not necessarily the views of Apricity Real Estate. We are not responsible for the accuracy or reliability of user-generated content.
              </p>
            </section>

            <section className="mb-8">
              <h2 className="text-2xl font-serif font-normal text-gray-900 mb-4 font-serif">5. Financial and Investment Disclaimer</h2>
              
              <h3 className="text-xl font-serif font-normal text-gray-800 mb-3 font-serif">5.1 Investment Risks</h3>
              <p className="text-gray-700 mb-4">
              ...
              <h3 className="text-xl font-serif font-normal text-gray-800 mb-3 font-serif">5.2 Financial Information</h3>
              <p className="text-gray-700 mb-4">
              ...
              <h3 className="text-xl font-serif font-normal text-gray-800 mb-3 font-serif">5.3 Currency and Exchange Rates</h3>
              <p className="text-gray-700 mb-4">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-serif font-normal text-gray-900 mb-4 font-serif">6. Limitation of Liability</h2>
              <p className="text-gray-700 mb-4">
                In no event shall Apricity Real Estate, its officers, directors, employees, agents, or affiliates be liable for any direct, indirect, incidental, special, consequential, or punitive damages, including but not limited to:
              </p>
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-serif font-normal text-gray-900 mb-4 font-serif">7. Indemnification</h2>
              <p className="text-gray-700 mb-4">
                You agree to indemnify and hold harmless Apricity Real Estate, its officers, directors, employees, agents, and affiliates from any claims, damages, losses, or expenses (including reasonable attorney's fees) arising from:
              </p>
              <ul className="list-disc pl-6 mb-4 text-gray-700">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-serif font-normal text-gray-900 mb-4 font-serif">8. Force Majeure</h2>
              <p className="text-gray-700 mb-4">
                Apricity Real Estate shall not be liable for any failure or delay in performance due to circumstances beyond our reasonable control, including but not limited to:
              </p>
              <ul className="list-disc pl-6 mb-4 text-gray-700">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-serif font-normal text-gray-900 mb-4 font-serif">9. Governing Law and Jurisdiction</h2>
              <p className="text-gray-700 mb-4">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-serif font-normal text-gray-900 mb-4 font-serif">10. Severability</h2>
              <p className="text-gray-700 mb-4">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-serif font-normal text-gray-900 mb-4 font-serif">11. Updates to This Disclaimer</h2>
              <p className="text-gray-700 mb-4">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-serif font-normal text-gray-900 mb-4 font-serif">13. Acknowledgment</h2>
              <p className="text-gray-700 mb-4">
