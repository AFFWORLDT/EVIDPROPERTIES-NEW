...
export const metadata: Metadata = {
  title: 'Cookie Policy - Apricity Real Estate',
  description: 'Cookie Policy for Apricity Real Estate - Learn about how we use cookies and similar technologies.',
};
        ...
        <div className="bg-white rounded-lg shadow-lg p-8">
          ...
          <div className="prose prose-lg max-w-none">
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-700 mb-4">
                Apricity Real Estate uses cookies for the following purposes:
              </p>
