...
export const metadata: Metadata = {
  title: 'Terms and Conditions - Apricity Real Estate',
  description: 'Terms and Conditions for Apricity Real Estate - Read our terms of service and user agreement.',
};
          ...
          <div className="prose prose-lg max-w-none">
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-700 mb-4">
                Welcome to Apricity Real Estate. These Terms and Conditions ("Terms") govern your use of our website <a href="https://apricityrealestate.com" className="text-blue-600 hover:underline">apricityrealestate.com</a> and our services. By accessing or using our website, you agree to be bound by these Terms.
              </p>
              <p className="text-gray-700 mb-4">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-serif font-normal text-gray-900 mb-4 font-serif">2. About Apricity Real Estate</h2>
              <p className="text-gray-700 mb-4">
                Apricity Real Estate is a real estate platform based in Dubai, UAE, providing property listings, real estate services, and related services. We are committed to connecting property buyers, sellers, and renters in the Dubai real estate market.
              </p>
              <div className="bg-gray-50 p-6 rounded-lg mb-4">
                <p className="text-gray-700 mb-2"><strong>Company Information:</strong></p>
                <p className="text-gray-700 mb-2">Apricity Real Estate</p>
                ...
                <p className="text-gray-700">Email: <a href="mailto:info@apricityrealestate.ae" className="text-blue-600 hover:underline">info@apricityrealestate.ae</a></p>
              </div>
            </section>

            <section className="mb-8">
              <h2 className="text-2xl font-serif font-normal text-gray-900 mb-4 font-serif">3. Services Provided</h2>
              <p className="text-gray-700 mb-4">Apricity Real Estate provides the following services:</p>
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-700 mb-4">
                The website and its content, including but not limited to text, graphics, logos, images, and software, are the property of Apricity Real Estate or its licensors and are protected by copyright, trademark, and other intellectual property laws.
              </p>
              <p className="text-gray-700 mb-4">
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-700 mb-4">
                To the maximum extent permitted by law, Apricity Real Estate shall not be liable for any direct, indirect, incidental, special, or consequential damages arising from your use of the website or services.
              </p>
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-700 mb-4">
                You agree to indemnify and hold harmless Apricity Real Estate, its officers, directors, employees, and agents from any claims, damages, or expenses arising from your use of the website or violation of these Terms.
              </p>
            </section>
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-700 mb-4">
                These Terms, together with our Privacy Policy and any other legal notices published on our website, constitute the entire agreement between you and Apricity Real Estate regarding your use of our website and services.
              </p>
            </section>
          </div>
        </div>
