      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className="text-center mb-16">
          ...
          <h2 className="text-4xl sm:text-5xl lg:text-6xl font-serif font-normal mb-8 text-gray-800 leading-tight" style={{ letterSpacing: '0.05em' }}>
            <span className="text-gray-800 font-normal">Calculate</span> Your 
            <br />
            <span className="text-2xl sm:text-3xl lg:text-4xl font-normal text-gray-800 mt-2 block" style={{ letterSpacing: '0.05em' }}>
        ...
        {/* Bank Partners */}
        <div className="text-center mb-16">
          <h3 className="text-xl font-serif font-normal text-gray-700 mb-8" style={{ letterSpacing: '0.05em' }}>
          ...
          <div className="flex flex-wrap justify-center items-center gap-8 opacity-70">
            <div className="bg-white/80 backdrop-blur-sm px-6 py-4 rounded-xl shadow-lg border border-white/20">
              <div className="text-gray-800 font-serif font-normal text-lg" style={{ letterSpacing: '0.05em' }}>ADCB</div>
              <div className="text-xs text-gray-500 font-serif">بنك أبوظبي التجاري</div>
            </div>
            <div className="bg-white/80 backdrop-blur-sm px-6 py-4 rounded-xl shadow-lg border border-white/20">
              <div className="text-gray-800 font-serif font-normal text-lg" style={{ letterSpacing: '0.05em' }}>Emirates NBD</div>
            </div>
            <div className="bg-white/80 backdrop-blur-sm px-6 py-4 rounded-xl shadow-lg border border-white/20">
              <div className="text-gray-800 font-serif font-normal text-lg" style={{ letterSpacing: '0.05em' }}>ADIB</div>
              <div className="text-xs text-gray-500 font-serif">مصرف أبوظبي الإسلامي</div>
            </div>
            <div className="bg-white/80 backdrop-blur-sm px-6 py-4 rounded-xl shadow-lg border border-white/20">
              <div className="text-gray-800 font-serif font-normal text-lg" style={{ letterSpacing: '0.05em' }}>Mashreq</div>
              <div className="text-xs text-gray-500 font-serif">المشرق</div>
            </div>
            <div className="bg-white/80 backdrop-blur-sm px-6 py-4 rounded-xl shadow-lg border border-white/20">
              <div className="text-gray-800 font-serif font-normal text-lg" style={{ letterSpacing: '0.05em' }}>FAB</div>
              <div className="text-xs text-gray-500 font-serif">بنك أبوظبي الأول</div>
            </div>
            <div className="bg-white/80 backdrop-blur-sm px-6 py-4 rounded-xl shadow-lg border border-white/20">
              <div className="text-gray-800 font-serif font-normal text-lg" style={{ letterSpacing: '0.05em' }}>CBD</div>
              <div className="text-xs text-gray-500 font-serif">Commercial Bank of Dubai</div>
            </div>
          </div>
        </div>
            ...
            <div className="grid lg:grid-cols-2 gap-12">
              ...
              <div>
                <div className="flex items-center mb-8">
                  ...
                  <h3 className="text-3xl font-serif font-normal text-gray-800" style={{ letterSpacing: '0.05em' }}>
                    Mortgage Calculator
                  </h3>
                </div>
                <p className="text-gray-600 mb-8 font-serif font-normal leading-relaxed" style={{ letterSpacing: '0.05em' }}>
                Calculate your monthly payments with our mortgage calculator. Get instant results & plan your investment.
                </p>

                <div className="space-y-6">
                  <div>
                    <label className="flex items-center text-sm font-serif font-normal text-gray-700 mb-3" style={{ letterSpacing: '0.05em' }}>
              ...
              <div className="space-y-6">
                <div className="bg-gradient-to-br from-[#dbbb90]/10 to-[#C2A17B]/10 rounded-2xl p-8 border border-[#dbbb90]/20">
                  <h4 className="text-xl font-serif font-normal text-gray-800 mb-6 text-center" style={{ letterSpacing: '0.05em' }}>
                    Your Monthly Payment
                  </h4>
                  <div className="text-center">
                    <div className="text-4xl font-serif font-normal text-[#dbbb90] mb-2 flex items-center justify-center gap-2" style={{ letterSpacing: '0.05em' }}>
                      <DirhamSymbol size={24} />
                      {monthlyPayment.toLocaleString('en-US', { maximumFractionDigits: 0 })}
                    </div>
                    <div className="text-gray-600 font-serif font-normal" style={{ letterSpacing: '0.05em' }}>per month</div>
                  </div>
                </div>

                <div className="bg-white/50 backdrop-blur-sm rounded-xl p-6 border border-white/20">
                  <div className="text-sm text-gray-600 font-serif font-normal mb-2" style={{ letterSpacing: '0.05em' }}>Loan Amount</div>
                  <div className="text-xl font-serif font-normal text-gray-800 flex items-center gap-1" style={{ letterSpacing: '0.05em' }}>
                ...
                <div className="space-y-4">
                  ...
                  <Button variant="outline" className="w-full bg-white/50 hover:bg-white/70 text-gray-800 border-[#dbbb90]/30 hover:border-[#dbbb90] px-8 py-6 text-lg font-serif font-normal rounded-xl transition-all duration-500 transform hover:scale-105 hover:-translate-y-1 backdrop-blur-sm" style={{ letterSpacing: '0.05em' }}>
